...
import { Fragment, ViewTransition, cloneElement, createElement, memo, startTransition, useDeferredValue, useEffect, useImperativeHandle, useLayoutEffect, useReducer, useRef, useState } from "react";
...
var code_block_view_module_default = {
	"CopyButton": "meow_CopyButton_SrTaXW",
	"Empty": "meow_Empty_SrTaXW",
	"Item": "meow_Item_SrTaXW",
	"ItemIndicator": "meow_ItemIndicator_SrTaXW",
	"ItemText": "meow_ItemText_SrTaXW",
	"List": "meow_List_SrTaXW",
	"MermaidPreview": "meow_MermaidPreview_SrTaXW",
	"Popup": "meow_Popup_SrTaXW",
	"Positioner": "meow_Positioner_SrTaXW",
	"Preview": "meow_Preview_SrTaXW",
	"Root": "meow_Root_SrTaXW",
	"Search": "meow_Search_SrTaXW",
	"SearchRow": "meow_SearchRow_SrTaXW",
	"Toolbar": "meow_Toolbar_SrTaXW",
	"Trigger": "meow_Trigger_SrTaXW",
	"TriggerIcon": "meow_TriggerIcon_SrTaXW"
};
...
function CopyButton(t0) {
	...
	let rest;
	if ($[0] !== t0) {
		({getText, label, onCopy, className, ...rest} = t0);
		$[0] = t0;
		$[1] = className;
		$[2] = getText;
		$[3] = label;
	...
	if ($[6] !== getText || $[7] !== onCopy) {
		t1 = async () => {
			try {
				...
				console.warn("[meowdown] Failed to copy:", t2);
			}
		};
		$[6] = getText;
		$[7] = onCopy;
	...
	const copy = t1;
	const t2 = copied ? "" : void 0;
	const t3 = copied ? "Copied" : label;
	const t4 = copied ? "Copied" : label;
	let t5;
	if ($[9] !== copied) {
		t5 = copied ? /* @__PURE__ */ jsx(CheckIcon, {}) : /* @__PURE__ */ jsx(CopyIcon, {});
		$[9] = copied;
		$[10] = t5;
	} else t5 = $[10];
	let t6;
	if ($[11] !== className || $[12] !== copy || $[13] !== rest || $[14] !== t2 || $[15] !== t3 || $[16] !== t4 || $[17] !== t5) {
...
var block_handle_module_default = {
	"Draggable": "meow_Draggable_SG6zQq",
	"Popup": "meow_Popup_SG6zQq",
	"Positioner": "meow_Positioner_SG6zQq"
};
...
var drop_indicator_module_default = { "DropIndicator": "meow_DropIndicator_WMg5ha" };
...
var link_menu_module_default = {
	"Actions": "meow_Actions_ICQgXq",
	"Button": "meow_Button_ICQgXq",
	"Description": "meow_Description_ICQgXq",
	"Field": "meow_Field_ICQgXq",
	"Form": "meow_Form_ICQgXq",
	"FormActions": "meow_FormActions_ICQgXq",
	"Host": "meow_Host_ICQgXq",
	"Icon": "meow_Icon_ICQgXq",
	"Input": "meow_Input_ICQgXq",
	"Popup": "meow_Popup_ICQgXq",
	"Positioner": "meow_Positioner_ICQgXq",
	"Preview": "meow_Preview_ICQgXq",
	"PreviewBody": "meow_PreviewBody_ICQgXq",
	"pulse": "meow_pulse_ICQgXq",
	"RemoveButton": "meow_RemoveButton_ICQgXq",
	"ReplaceButton": "meow_ReplaceButton_ICQgXq",
	"ReplaceRow": "meow_ReplaceRow_ICQgXq",
	"Row": "meow_Row_ICQgXq",
	"SaveButton": "meow_SaveButton_ICQgXq",
	"Skeleton": "meow_Skeleton_ICQgXq",
	"SkeletonLine": "meow_SkeletonLine_ICQgXq",
	"SkeletonLineShort": "meow_SkeletonLineShort_ICQgXq",
	"Title": "meow_Title_ICQgXq",
	"Url": "meow_Url_ICQgXq",
	"UseTitleButton": "meow_UseTitleButton_ICQgXq"
};
...
function LinkMenu(t0) {
	const $ = c(58);
	const { onLinkClick, onLinkCopy, resolveLinkPreview, readOnly: t1 } = t0;
	...
	if ($[0] !== editor) {
		t2 = () => {
			const canLeave = () => !isPointerOverPopupRef.current;
			const linkHoverExtension = defineLinkHoverHandler((hit) => dispatch({
				type: "hover",
				link: hit?.payload
			}), { canLeave });
	...
	let t4;
	let t5;
	if ($[3] !== editor || $[4] !== readOnly) {
		t4 = () => {
			if (readOnly) return;
			const linkEditExtension = defineLinkEditKeymap((edit) => dispatch({
				type: "edit",
				edit
			}));
	...
	let t9;
	if ($[12] !== close || $[13] !== editor.commands) {
		t9 = () => {
	...
	const handleEditRemove = t9;
	let t10;
	if ($[15] !== close || $[16] !== edit_0 || $[17] !== editor.commands) {
		t10 = (text, href) => {
			if (!edit_0) return;
	...
	const handleEditSubmit = t10;
	const mutable = link != null && !readOnly && link.form !== "reference";
	let t11;
	if ($[19] !== link) {
		t11 = link ? getLinkText(link) : "";
		$[19] = link;
		$[20] = t11;
	} else t11 = $[20];
	const linkText = t11;
	let t12;
	if ($[21] !== editor || $[22] !== link || $[23] !== linkText) {
		t12 = () => {
			if (!link) return;
	...
	const removeLink = t13;
	let t14;
	bb0: {
		if (!link || !mutable || !isLinkTextForHref(linkText, link.href)) {
			t14 = void 0;
			break bb0;
		}
		let t15;
		if ($[29] !== close || $[30] !== editor || $[31] !== link) {
			t15 = (title) => {
				selectLinkUnit(editor, link);
	...
	bb1: {
		...
		let t16;
		if ($[33] !== editor.view || $[34] !== range) {
			t16 = getVirtualElementFromRange(editor.view, range);
			$[33] = editor.view;
			$[34] = range;
			$[35] = t16;
		} else t16 = $[35];
	...
	const anchor = t15;
	const t16 = state.kind === "preview" || state.kind === "edit";
	let t17;
	if ($[36] !== edit_0 || $[37] !== editor) {
		t17 = () => {
	...
	let t18;
	if ($[39] !== editLink || $[40] !== edit_0 || $[41] !== handleEditRemove || $[42] !== handleEditSubmit || $[43] !== handleUseTitle || $[44] !== link || $[45] !== mutable || $[46] !== onLinkClick || $[47] !== onLinkCopy || $[48] !== previewState || $[49] !== removeLink || $[50] !== resolveLinkPreview) {
		t18 = edit_0 ? /* @__PURE__ */ jsx(LinkEditContent, {
			edit: edit_0,
			resolveLinkPreview,
		...
		$[48] = previewState;
		$[49] = removeLink;
		$[50] = resolveLinkPreview;
		$[51] = t18;
	} else t18 = $[51];
	let t19;
	if ($[52] !== anchor || $[53] !== close || $[54] !== t16 || $[55] !== t17 || $[56] !== t18) {
		t19 = /* @__PURE__ */ jsx(LinkPopover, {
			anchor,
			open: t16,
			onClose: close,
			onCloseComplete: t17,
...
var pending_replacement_preview_module_default = {
	"AcceptButton": "meow_AcceptButton_vi3iGa",
	"Button": "meow_Button_vi3iGa",
	"Footer": "meow_Footer_vi3iGa",
	"Popup": "meow_Popup_vi3iGa",
	"Positioner": "meow_Positioner_vi3iGa",
	"Spacer": "meow_Spacer_vi3iGa",
	"Text": "meow_Text_vi3iGa",
	"Waiting": "meow_Waiting_vi3iGa"
};
...
var selection_menu_module_default = {
	"AffordanceButton": "meow_AffordanceButton_Id-0UG",
	"AffordancePopup": "meow_AffordancePopup_Id-0UG",
	"AffordancePositioner": "meow_AffordancePositioner_Id-0UG",
	"Detail": "meow_Detail_Id-0UG",
	"Empty": "meow_Empty_Id-0UG",
	"Input": "meow_Input_Id-0UG",
	"Item": "meow_Item_Id-0UG",
	"Label": "meow_Label_Id-0UG",
	"List": "meow_List_Id-0UG",
	"Popup": "meow_Popup_Id-0UG",
	"Positioner": "meow_Positioner_Id-0UG"
};
...
var autocomplete_menu_module_default = {
	"Detail": "meow_Detail_QB6dRq",
	"Item": "meow_Item_QB6dRq",
	"Label": "meow_Label_QB6dRq",
	"Popup": "meow_Popup_QB6dRq",
	"Positioner": "meow_Positioner_QB6dRq"
};
...
var table_handle_module_default = {
	"ColumnPopup": "meow_ColumnPopup_KAdgtW",
	"MenuItem": "meow_MenuItem_KAdgtW",
	"MenuPopup": "meow_MenuPopup_KAdgtW",
	"MenuPositioner": "meow_MenuPositioner_KAdgtW",
	"Positioner": "meow_Positioner_KAdgtW",
	"RowPopup": "meow_RowPopup_KAdgtW",
	"Trigger": "meow_Trigger_KAdgtW"
};
...
function ProseKitEditor(t0) {
	const $ = c(102);
	const { markMode: t1, initialMarkdown, onDocChange, onSlashMenuSearch, onTagSearch, onWikilinkSearch, onSelectionMenuSearch, selectionMenuAffordance: t2, pendingReplacementActions, onPendingReplacementResolve, onWikilinkClick, onLinkClick, onLinkCopy, resolveLinkPreview, onTagClick, onExitBoundary, resolveImageUrl, resolveFileLink, resolveWikiEmbed, resolveWikilink, resolveFileInfo, resolveXPost, mediaUrlProtocols, resolveYouTubeVideo, onFileClick, onFilePaste, onFileSaveError, onImageClick, onXPostMediaClick, onYouTubeVideoClick, embedPaste, linkPaste, bulletAfterHeading, substitution: t3, frontmatter: t4, blockHandle: t5, placeholder, readOnly, spellCheck, searchQuery: t6, onSearchChange, timeFormat, editorClassName, CodeBlockView, ref, children } = t0;
	const markMode = t1 === void 0 ? "focus" : t1;
	const selectionMenuAffordance = t2 === void 0 ? true : t2;
	const substitution = t3 === void 0 ? true : t3;
	const frontmatter = t4 === void 0 ? false : t4;
	const blockHandle = t5 === void 0 ? true : t5;
	const searchQuery = t6 === void 0 ? "" : t6;
	...
	const handleDocChange = t7;
	const wikilinkEnabled = !!onWikilinkSearch;
	let t8;
	if ($[2] !== bulletAfterHeading || $[3] !== editorClassName || $[4] !== embedPaste || $[5] !== linkPaste || $[6] !== markMode || $[7] !== mediaUrlProtocols || $[8] !== onExitBoundary || $[9] !== onFileClick || $[10] !== onFilePaste || $[11] !== onFileSaveError || $[12] !== onImageClick || $[13] !== onLinkClick || $[14] !== onTagClick || $[15] !== onWikilinkClick || $[16] !== onXPostMediaClick || $[17] !== onYouTubeVideoClick || $[18] !== placeholder || $[19] !== readOnly || $[20] !== resolveFileInfo || $[21] !== resolveFileLink || $[22] !== resolveImageUrl || $[23] !== resolveWikiEmbed || $[24] !== resolveWikilink || $[25] !== resolveXPost || $[26] !== resolveYouTubeVideo || $[27] !== spellCheck || $[28] !== substitution || $[29] !== wikilinkEnabled) {
		t8 = {
			markMode,
			resolveFileLink,
			resolveWikiEmbed,
		...
		$[14] = onTagClick;
		$[15] = onWikilinkClick;
		$[16] = onXPostMediaClick;
		$[17] = onYouTubeVideoClick;
		$[18] = placeholder;
		$[19] = readOnly;
		$[20] = resolveFileInfo;
		$[21] = resolveFileLink;
	...
	const config = t8;
	let t9;
	if ($[31] !== CodeBlockView || $[32] !== config || $[33] !== frontmatter || $[34] !== initialMarkdown) {
		t9 = () => {
	...
	const closeSelectionMenu = t11;
	let t12;
	let t13;
	if ($[39] !== editor_0 || $[40] !== frontmatter || $[41] !== hasSelectionMenu || $[42] !== openSelectionMenu) {
		t12 = () => {
			const getMarkdown = function getMarkdown() {
			...
			const replaceState = function replaceState(markdown, selection, t14, t15) {
				const addToHistory = t14 === void 0 ? true : t14;
				const forceMarkdown = t15 === void 0 ? false : t15;
			...
			const setState = function setState(markdown_0, selection_0) {
				replaceState(markdown_0, selection_0);
			};
			return {
				getMarkdown,
				setMarkdown: function setMarkdown(markdown_1) {
					setState(markdown_1);
				},
				insertMarkdown: function insertMarkdown(markdown_3) {
					editor_0.commands.insertMarkdown(markdown_3);
				},
				getState,
				setState,
				refreshMarkdownRendering: function refreshMarkdownRendering() {
					const [markdown_2, selection_1] = getState();
					replaceState(markdown_2, selection_1, false, true);
				},
				getSelection,
				setSelection: function setSelection(selection_2) {
				...
				revealHeading: function revealHeading(fragment) {
				...
				getSelectedText: function getSelectedTextFromState() {
					return getSelectedText(editor_0.state);
				},
				openSelectionMenu: function openSelectionMenuFromHandle() {
					if (!hasSelectionMenu) return;
					openSelectionMenu();
				},
				startPendingReplacement: function startPendingReplacement(options) {
					return editor_0.commands.startPendingReplacement(options);
				},
				appendPendingReplacementText: function appendPendingReplacementText(text) {
					editor_0.commands.appendPendingReplacementText(text);
				},
				acceptPendingReplacement: function acceptPendingReplacement(options_0) {
					editor_0.commands.acceptPendingReplacement(options_0 ?? {});
				},
				discardPendingReplacement: function discardPendingReplacement() {
	...
	let t14;
	if ($[45] !== editor_0) {
		t14 = (element) => editor_0.mount(element);
		$[45] = editor_0;
		$[46] = t14;
	} else t14 = $[46];
	const mount = t14;
	...
	if ($[47] === Symbol.for("react.memo_cache_sentinel")) {
		t15 = /* @__PURE__ */ jsx(VirtualCaret, {});
		$[47] = t15;
	} else t15 = $[47];
	let t16;
	if ($[48] !== mount) {
		t16 = /* @__PURE__ */ jsx("div", { ref: mount });
		$[48] = mount;
		$[49] = t16;
	} else t16 = $[49];
	let t17;
	if ($[50] !== config || $[51] !== handleDocChange || $[52] !== onSearchChange || $[53] !== searchQuery) {
		t17 = /* @__PURE__ */ jsx(EditorExtensions, {
			config,
			searchQuery,
	...
	let t18;
	if ($[55] !== blockHandle || $[56] !== readOnly) {
		t18 = blockHandle && !readOnly && /* @__PURE__ */ jsx(BlockHandle, {});
		$[55] = blockHandle;
		$[56] = readOnly;
		$[57] = t18;
	} else t18 = $[57];
	let t19;
	if ($[58] !== readOnly) {
		t19 = !readOnly && /* @__PURE__ */ jsx(TableHandle, {});
		$[58] = readOnly;
		$[59] = t19;
	} else t19 = $[59];
	let t20;
	if ($[60] !== blockHandle || $[61] !== readOnly) {
		t20 = blockHandle && !readOnly && /* @__PURE__ */ jsx(DropIndicator$1, {});
		$[60] = blockHandle;
		$[61] = readOnly;
		$[62] = t20;
	} else t20 = $[62];
	let t21;
	if ($[63] !== onFilePaste || $[64] !== onFileSaveError || $[65] !== onSlashMenuSearch || $[66] !== timeFormat) {
		t21 = /* @__PURE__ */ jsx(SlashMenu, {
			timeFormat,
			onSlashMenuSearch,
			onFilePaste,
			onFileSaveError
		...
		$[63] = onFilePaste;
		$[64] = onFileSaveError;
		$[65] = onSlashMenuSearch;
		$[66] = timeFormat;
		$[67] = t21;
	} else t21 = $[67];
	const t22 = String(readOnly);
	let t23;
	if ($[68] !== onLinkClick || $[69] !== onLinkCopy || $[70] !== readOnly || $[71] !== resolveLinkPreview || $[72] !== t22) {
		t23 = /* @__PURE__ */ jsx(LinkMenu, {
			onLinkClick,
			onLinkCopy,
			resolveLinkPreview,
			readOnly
		...
		$[69] = onLinkCopy;
		$[70] = readOnly;
		$[71] = resolveLinkPreview;
		$[72] = t22;
		$[73] = t23;
	} else t23 = $[73];
	let t24;
	if ($[74] !== onTagSearch) {
		t24 = onTagSearch && /* @__PURE__ */ jsx(TagMenu, { onTagSearch });
		$[74] = onTagSearch;
		$[75] = t24;
	} else t24 = $[75];
	let t25;
	if ($[76] !== onWikilinkSearch) {
		t25 = onWikilinkSearch && /* @__PURE__ */ jsx(WikilinkMenu, { onWikilinkSearch });
		$[76] = onWikilinkSearch;
		$[77] = t25;
	} else t25 = $[77];
	let t26;
	if ($[78] !== onSelectionMenuSearch || $[79] !== openSelectionMenu || $[80] !== readOnly || $[81] !== selectionMenuAffordance || $[82] !== selectionMenuContext) {
		t26 = onSelectionMenuSearch && !readOnly && /* @__PURE__ */ jsx(SelectionMenu, {
			onSelectionMenuSearch,
		...
		$[78] = onSelectionMenuSearch;
		$[79] = openSelectionMenu;
		$[80] = readOnly;
		$[81] = selectionMenuAffordance;
		$[82] = selectionMenuContext;
		$[83] = t26;
	} else t26 = $[83];
	let t27;
	if ($[84] !== onPendingReplacementResolve || $[85] !== pendingReplacementActions || $[86] !== readOnly) {
		t27 = !readOnly && /* @__PURE__ */ jsx(PendingReplacementPreview, {
			actions: pendingReplacementActions,
			onResolve: onPendingReplacementResolve
		});
		$[84] = onPendingReplacementResolve;
		$[85] = pendingReplacementActions;
		$[86] = readOnly;
		$[87] = t27;
	} else t27 = $[87];
	let t28;
	if ($[88] !== children || $[89] !== editor_0 || $[90] !== t16 || $[91] !== t17 || $[92] !== t18 || $[93] !== t19 || $[94] !== t20 || $[95] !== t21 || $[96] !== t23 || $[97] !== t24 || $[98] !== t25 || $[99] !== t26 || $[100] !== t27) {
		t28 = /* @__PURE__ */ jsxs(ProseKit, {
			editor: editor_0,
			children: [
				t15,
				t16,
...
*/
function MeowdownEditor(t0) {
	const $ = c(54);
	const { mode: t1, initialMarkdown, onDocChange, onSlashMenuSearch, onTagSearch, onWikilinkSearch, onSelectionMenuSearch, selectionMenuAffordance: t2, pendingReplacementActions, onPendingReplacementResolve, onWikilinkClick, onLinkClick, onLinkCopy, resolveLinkPreview, onTagClick, onExitBoundary, resolveImageUrl, resolveFileLink, resolveWikiEmbed, resolveWikilink, resolveFileInfo, resolveXPost, mediaUrlProtocols, resolveYouTubeVideo, onFileClick, onFilePaste, onFileSaveError, onImageClick, onXPostMediaClick, onYouTubeVideoClick, embedPaste: t3, linkPaste: t4, bulletAfterHeading: t5, substitution: t6, frontmatter: t7, blockHandle: t8, caretGlide: t9, placeholder, readOnly, spellCheck, searchQuery, onSearchChange, timeFormat, editorClassName, wrapperClassName, CodeBlockView, handleRef, children } = t0;
	const mode = t1 === void 0 ? "focus" : t1;
	const selectionMenuAffordance = t2 === void 0 ? true : t2;
	const embedPaste = t3 === void 0 ? true : t3;
	const linkPaste = t4 === void 0 ? true : t4;
	const bulletAfterHeading = t5 === void 0 ? false : t5;
	const substitution = t6 === void 0 ? true : t6;
	const frontmatter = t7 === void 0 ? false : t7;
	const blockHandle = t8 === void 0 ? true : t8;
	const caretGlide = t9 === void 0 ? true : t9;
	...
	if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
		t10 = () => {
			return {
				...
				insertMarkdown: function insertMarkdown(markdown_0) {
				...
				setState: function setState(markdown_1, selection) {
				...
				setSelection: function setSelection(selection_0) {
				...
				openSelectionMenu: function openSelectionMenu() {
	...
	useImperativeHandle(handleRef, t10, t11);
	let t12;
	if ($[2] !== wrapperClassName) {
		t12 = clsx("meowdown", wrapperClassName);
		$[2] = wrapperClassName;
		$[3] = t12;
	} else t12 = $[3];
	const t13 = caretGlide ? void 0 : CARET_GLIDE_OFF;
	let t14;
	if ($[4] !== CodeBlockView || $[5] !== blockHandle || $[6] !== bulletAfterHeading || $[7] !== children || $[8] !== editorClassName || $[9] !== embedPaste || $[10] !== frontmatter || $[11] !== initialMarkdown || $[12] !== linkPaste || $[13] !== mediaUrlProtocols || $[14] !== mode || $[15] !== onDocChange || $[16] !== onExitBoundary || $[17] !== onFileClick || $[18] !== onFilePaste || $[19] !== onFileSaveError || $[20] !== onImageClick || $[21] !== onLinkClick || $[22] !== onLinkCopy || $[23] !== onPendingReplacementResolve || $[24] !== onSearchChange || $[25] !== onSelectionMenuSearch || $[26] !== onSlashMenuSearch || $[27] !== onTagClick || $[28] !== onTagSearch || $[29] !== onWikilinkClick || $[30] !== onWikilinkSearch || $[31] !== onXPostMediaClick || $[32] !== onYouTubeVideoClick || $[33] !== pendingReplacementActions || $[34] !== placeholder || $[35] !== readOnly || $[36] !== resolveFileInfo || $[37] !== resolveFileLink || $[38] !== resolveImageUrl || $[39] !== resolveLinkPreview || $[40] !== resolveWikiEmbed || $[41] !== resolveWikilink || $[42] !== resolveXPost || $[43] !== resolveYouTubeVideo || $[44] !== searchQuery || $[45] !== selectionMenuAffordance || $[46] !== spellCheck || $[47] !== substitution || $[48] !== timeFormat) {
		t14 = /* @__PURE__ */ jsx(ProseKitEditor, {
			ref: childRef,
			markMode: mode,
			initialMarkdown,
			onDocChange,
		...
		$[21] = onLinkClick;
		$[22] = onLinkCopy;
		$[23] = onPendingReplacementResolve;
		$[24] = onSearchChange;
		$[25] = onSelectionMenuSearch;
		$[26] = onSlashMenuSearch;
		$[27] = onTagClick;
		$[28] = onTagSearch;
		$[29] = onWikilinkClick;
		$[30] = onWikilinkSearch;
		$[31] = onXPostMediaClick;
		$[32] = onYouTubeVideoClick;
		$[33] = pendingReplacementActions;
		$[34] = placeholder;
		$[35] = readOnly;
		$[36] = resolveFileInfo;
		$[37] = resolveFileLink;
		$[38] = resolveImageUrl;
		$[39] = resolveLinkPreview;
		$[40] = resolveWikiEmbed;
		$[41] = resolveWikilink;
		$[42] = resolveXPost;
		$[43] = resolveYouTubeVideo;
		$[44] = searchQuery;
		$[45] = selectionMenuAffordance;
		$[46] = spellCheck;
		$[47] = substitution;
		$[48] = timeFormat;
		$[49] = t14;
...
function FileView(props) {
		...
		t0 = () => {
			...
			const load = async () => {
				try {
					...
					console.error("[meowdown] resolveFileInfo failed:", t2);
				}
			};
			load();
			return () => {
	...
	let t2;
	if ($[4] !== context || $[5] !== href || $[6] !== name) {
		t2 = context.onFileClick ? (event) => {
			context.onFileClick?.({
				href,
				name,
				event: event.nativeEvent,
	...
	let t7;
	if ($[15] !== handleClick || $[16] !== name || $[17] !== t3 || $[18] !== t5 || $[19] !== t6) {
...
var lightbox_module_default = {
	"Dialog": "meow_Dialog_3sbw2a",
	"Frame": "meow_Frame_3sbw2a",
	"Image": "meow_Image_3sbw2a",
	"Video": "meow_Video_3sbw2a"
};
...
var wikilink_hover_card_module_default = {
	"Popup": "meow_Popup_OB69na",
	"Positioner": "meow_Positioner_OB69na",
	"Viewport": "meow_Viewport_OB69na"
};
...
function WikilinkHoverCard(t0) {
	...
	let t1;
	if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
		t1 = () => defineWikilinkHoverHandler((nextHit) => {
			setHit(nextHit);
	...
	const [hoverExtension] = useState(t1);
	...
	let t3;
	if ($[3] !== getRect) {
		t3 = { getBoundingClientRect: getRect };
		$[3] = getRect;
		$[4] = t3;
	} else t3 = $[4];
	const anchor = t3;
	...
	let t9;
	if ($[11] !== anchor || $[12] !== body || $[13] !== className) {
		t9 = body != null && /* @__PURE__ */ jsx(PreviewCard.Portal, { children: /* @__PURE__ */ jsx(PreviewCard.Positioner, {
			anchor,
			side: "bottom",
			sideOffset: 8,
			collisionPadding: 8,
	...
	let t10;
	if ($[15] !== t6 || $[16] !== t9) {
		t10 = /* @__PURE__ */ jsx(PreviewCard.Root, {
			open: t6,
			onOpenChange: t7,
			onOpenChangeComplete: t8,
			children: t9
		});
		$[15] = t6;
		$[16] = t9;
