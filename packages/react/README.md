...
- `htmlPaste?: boolean`: converts pasted rich-text HTML (a bullet list, bold, a link, ...) into Markdown so the formatting survives instead of arriving as plain text. On by default; set `false` to disable. Ignored in source mode.
