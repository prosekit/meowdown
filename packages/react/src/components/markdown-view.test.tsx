...
describe('MarkdownView', () => {
  ...
  it('omits recognized embeds before resolving images when renderEmbeds is false', async () => {
  ...
  it('renders a passive tree when interactive is false', async () => {
    ...
    expect(root.querySelector('iframe')?.tabIndex).toBe(-1)
    expect(root.querySelector('iframe')?.parentElement?.hasAttribute('inert')).toBe(true)
    expect(
