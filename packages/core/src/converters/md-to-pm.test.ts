      ...
      content: [
        {
          ...
          attrs: {
            ...
            taskMarker: null,
            markerGap: 1,
            // The blank line between the item's paragraph and the fence makes
            // the list loose per CommonMark.
            loose: true,
          },
          content: [
      ...
      content: [
        {
          ...
          attrs: {
            ...
            taskMarker: null,
            markerGap: 1,
            // The blank line between the item's two paragraphs makes the list
            // loose per CommonMark.
            loose: true,
          },
          content: [
            { type: 'paragraph', content: [{ type: 'text', text: 'x' }] },
