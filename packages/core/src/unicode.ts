...
export const UNICODE_MEDIUM_VERTICAL_BAR = '\u{2759}' /* ❙ */
...
export const UNICODE_MATHEMATICAL_LEFT_ANGLE_BRACKET = '\u{27E8}' /* ⟨ */
...
export const UNICODE_BOX_DRAWINGS_HEAVY_VERTICAL_AND_LEFT = '\u{252B}' /* ┫ */
export const UNICODE_BOX_DRAWINGS_HEAVY_VERTICAL_AND_RIGHT = '\u{2523}' /* ┣ */
