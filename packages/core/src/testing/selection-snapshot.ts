...
import {
  ...
  UNICODE_LEFT_SQUARE_BRACKET_LOWER_CORNER,
  UNICODE_RIGHT_SQUARE_BRACKET_LOWER_CORNER,
} from '../unicode.ts'

const TEXT_CARET = UNICODE_BOX_DRAWINGS_HEAVY_VERTICAL
const TEXT_CARET_TAIL_LEFT = UNICODE_RIGHT_SQUARE_BRACKET_LOWER_CORNER
const TEXT_CARET_TAIL_RIGHT = UNICODE_LEFT_SQUARE_BRACKET_LOWER_CORNER
