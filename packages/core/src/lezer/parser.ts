 ...
 * task list, autolink) plus meowdown's `Hashtag` inline syntax. Use
 * when both block and inline structure must be recognized.
 */
export const gfmParser = defaultParser.configure([GFM, hashtag])
